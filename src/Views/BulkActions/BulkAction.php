...
namespace Rappasoft\LaravelLivewireTables\Views\BulkActions;

use Illuminate\View\Component;
use Rappasoft\LaravelLivewireTables\Views\BulkActions\Traits\{HandlesBulkActionAttributes,HandlesConfirmationMessage};
