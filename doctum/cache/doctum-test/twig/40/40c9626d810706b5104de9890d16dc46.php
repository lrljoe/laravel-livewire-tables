...
/* opensearch.twig */
class __TwigTemplate_76d6b4f8939441c8864efa081e2e9165 extends Template
{
    private $source;
...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/" xmlns:referrer="http://a9.com/-/opensearch/extensions/referrer/">
    <ShortName>';
            ...
            })()), 'config', [0 => 'title'], 'method', false, false, false, 4), 'html', null, true);
            echo ' (';
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
                throw new RuntimeError('Variable "project" does not exist.', 4, $this->source);
    ...
    <Description>';
            ...
            })()), 'config', [0 => 'title'], 'method', false, false, false, 5), 'html', null, true);
            echo ' (';
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function () {
                throw new RuntimeError('Variable "project" does not exist.', 5, $this->source);
...
{% endif %}
", 'opensearch.twig', 'phar:///bin/doctum/src/Resources/themes/default/opensearch.twig');
    }
}
