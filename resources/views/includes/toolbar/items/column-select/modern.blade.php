...
@if ($isTailwind || $isTailwind4)
    <div @class([
            'hidden sm:block' => $csIsHiddenOnMobile,
            'hidden md:block @endif mb-4 w-full md:w-auto md:mb-0 md:ml-2' => $csIsHiddenOnTablet,
        ])
    >
        <div
            x-data="{ 
                ...
                <span class="rounded-md shadow-sm">
                    <button
                        ...
                        {{
                            ...
                            ->class([
                                'inline-flex justify-center px-4 py-2 w-full text-sm font-medium rounded-md border shadow-sm focus:ring focus:ring-opacity-50' => $columnSelectButtonAttributes['default-styling'],
