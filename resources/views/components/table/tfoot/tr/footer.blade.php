@aware([ 'tableName', 'selectedVisibleColumns','showBulkActionsSections','hasCollapsingColumns'])
...
>
    ...
    @if ($hasCollapsingColumns)
        <x-livewire-tables::table.td.collapsed-columns :hidden=true :displayMinimisedOnReorder="true" wire:key="{{ $tableName .'footer-collapsed-hide' }}"  />
    @endif
